...
1. **快慢指针判断有无环路**
   ...
   通过两个指针同时遍历链表，慢指针每次迭代一次，快指针每次迭代两次，若是有环路则必相遇，若是不相遇则无环路即循环结束二者不相等。

2. **确定有环路之后如何找到环路入环口**

   <img src="D:\Typora Picture\image-20260328140054675.png" alt="image-20260328140054675" style="zoom: 80%;" />
